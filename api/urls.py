...
from api.users.views import LoginView, RegisterNewUserView, UserLinkActivationView
...
urlpatterns = [
    ...
    path('v1/users/register', RegisterNewUserView.as_view(), name='api_users_register'),
    path('v1/users/link/activation/<str:key>', UserLinkActivationView.as_view(), name='api_link_activation'),
